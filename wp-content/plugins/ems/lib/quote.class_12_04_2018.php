                        ...
                        $weight = 'w' . $weight;
                            ...
                            if ($row->servicelevel_name == 'EXPRESS WORLDWIDE DOC'):
                                ...
                                if ($journey == 'single'):
                                    ...
                                    $final_data[$weight . 'kg']['express']['url'] = get_bloginfo('home') . "/order?cf=" . $row->service_from_country_code . "&ct=" . $row->service_to_country_code . "&amp;pr=" . $amount . "&amp;kg=" . $ow . "&amp;protocol=express";
                                else:
                                    $final_data[$weight . 'kg']['express']['amount'] = number_format($amount * 2, 2);
                                    $final_data[$weight . 'kg']['express']['currency'] = $currency;
                                    $ow = str_replace('w', '', $weight);
                                    $final_data[$weight . 'kg']['express']['url'] = get_bloginfo('home') . "/order?cf=" . $row->service_from_country_code . "&ct=" . $row->service_to_country_code . "&amp;pr=" . number_format($amount * 2, 2) . "&amp;kg=" . $ow . "&amp;protocol=express";
                                endif;
                            endif;
                            ...
                            if ($row->servicelevel_name == 'ECONOMY SELECT DOC'):
                                ...
                                if ($journey == 'single'):
                                    ...
                                    $final_data[$weight . 'kg']['standard']['currency'] = $currency;
                                    $ow = str_replace('w', '', $weight);
                                    $final_data[$weight . 'kg']['standard']['url'] = get_bloginfo('home') . "/order?cf=" . $row->service_from_country_code . "&ct=" . $row->service_to_country_code . "&amp;pr=" . number_format($amount * 2, 2) . "&amp;kg=" . $ow . "&amp;protocol=express";
                                endif;
                            endif;
