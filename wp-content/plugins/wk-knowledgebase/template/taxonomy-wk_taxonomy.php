<?php
    ...
    /*
    *   This template shows particular category articles.
    */
    ...
    $wk_cat_slug = get_queried_object()->slug;
    
    $wk_cat_name = get_queried_object()->name;

    $wk_cat_id = get_queried_object_id();
            ...
            <div id="wk_articles_meta">
                    ...
                    <div class="wk-entry-category">
                                ...
                                <?php
                                    ...
                                    $term_meta = get_option( "taxonomy_$wk_cat_id" ); 
                                ?>
                                
                    </div>

                    <div class="wk-knw-title-cat">
                        <h3><?php echo $wk_cat_name;?><span> (<?php echo $wk_post_qry->found_posts; if($wk_post_qry->found_posts>1) echo ' Articles'; else echo ' Article';?>)</span></h3>

                    </div>
                    
                    <ul class="wk-cat-article-wrapper">
                        
                    <?php   while($wk_post_qry->have_posts()) :
