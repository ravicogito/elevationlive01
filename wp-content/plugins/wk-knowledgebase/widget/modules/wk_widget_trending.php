...
add_action( 'widgets_init', 'wk_article_trending_widgets' );
function wk_article_trending_widgets() {
    register_widget( 'wk_Article_trending_Widget' );
}

//========= Custom Knowledgebase Article Widget Body
class wk_Article_trending_Widget extends WP_Widget {
    
    //=======> Widget setup
    function __construct() {
        parent::__construct(
            'wk_article_trending_widgets', // Base ID
            __( 'Knowledgebase Trending Topics', 'wk' ), // Name
            array( 'description' => __('WP Knowledgebase Trending topic widget to show Trending topics on the site', 'wk'), 
                    'classname' => 'wk' ), // Args
            array( 'width' => 300, 'height' => 300, 'id_base' => 'wk_article_trending_widgets' )
        );
    }
