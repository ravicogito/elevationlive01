...
add_action( 'widgets_init', 'wk_article_widgets' );
function wk_article_widgets() {
    register_widget( 'wk_Article_Widget' );
}

//========= Custom Knowledgebase Article Widget Body
class wk_Article_Widget extends WP_Widget {
    
    //=======> Widget setup
    function __construct() {
        parent::__construct(
            'wk_article_widgets', // Base ID
            __( 'Knowledgebase Popular Article', 'wk' ), // Name
            array( 'description' => __('WP Knowledgebase Popular article widget to show Popular articles on the site', 'wk'), 
                    'classname' => 'wk' ), // Args
            array( 'width' => 300, 'height' => 300, 'id_base' => 'wk_article_widgets' )
        );
    }
