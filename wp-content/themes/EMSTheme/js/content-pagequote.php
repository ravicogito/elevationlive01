    	...
    	<form action="<?php bloginfo('home');?>/quote" class="form-inline" id="quick-quote" method="post" novalidate>
            ...
            <div class="col-md-12">
                ...
                <div id='ajax-show-info' class="row no-gutters whitetextboxlp" style="border: solid 1px #333; border-top: 0;">	
                    ...
                    <div class="col-md-6 standard-results">
                    	...
                    	<div class="row" style="padding-bottom:15px;">
                    	<div class="col-md-5"><span class="quick-quote-price-weight" style="width:105px;">Up to 15kg:</span> <span data-bind="text: Localise.formatCurrency(PriceIncTax())" class="quick-quote-price" id='data-15-standard'><img src='<?php bloginfo('template_url');?>/images/spinner.gif' /></span></div>
                    		<div class="col-md-7"> <a id="standard-15-button" href="http://www.expressmystuff.co.uk/order?cf=GB&amp;ct=ES&amp;pr=31.59&amp;kg=15&amp;protocol=standard" data-orig="http://www.expressmystuff.co.uk/order?cf=GB&amp;ct=ES&amp;pr=31.59&amp;kg=15&amp;protocol=standard" class="bnbtn btn btn-primary" data-price="">Book Now (15kg)</a></div>
						</div><!-- END INNER ROW --!>
                   	                   	                     	<div class="row" style="padding-bottom:15px;">
                    	                    	<div class="col-md-5"><span class="quick-quote-price-weight" style="width:105px;">Up to 30kg:</span> <span id='data-30-standard' data-bind="text: Localise.formatCurrency(PriceIncTax())" class="quick-quote-price"><img src='<?php bloginfo('template_url');?>/images/spinner.gif' /></span></div>
                    		<div class="col-md-7"> <a  id="standard-30-button" href="http://www.expressmystuff.co.uk/order?cf=GB&amp;ct=ES&amp;pr=31.59&amp;kg=30&amp;protocol=standard" data-orig="http://www.expressmystuff.co.uk/order?cf=GB&amp;ct=ES&amp;pr=31.59&amp;kg=30&amp;protocol=standard" class="bnbtn btn btn-primary" data-price="">Book Now (30kg)</a></div>
						</div><!-- END INNER ROW --!>
                    ...
                    <div class="col-md-6">
                    	...
                    	<div class="col-md-5"><span class="quick-quote-price-weight" style="width:105px;">Up to 5kg:</span> <span data-bind="text: Localise.formatCurrency(PriceIncTax())" class="quick-quote-price" id='data-5-express'><img src='<?php bloginfo('template_url');?>/images/spinner.gif' /></span></div>
                    	<div class="col-md-7"> <a  id="express-5-button" href="http://www.expressmystuff.co.uk/order?cf=GB&amp;ct=ES&amp;pr=44.43&amp;kg=5&amp;protocol=express" data-orig="http://www.expressmystuff.co.uk/order?cf=GB&amp;ct=ES&amp;pr=44.43&amp;kg=5&amp;protocol=express" class="bnbtn btn btn-primary" data-price="">Book Now (5kg)</a></div>
                    	</div><!-- END INNER ROW --!>
                    	                    	                    	<div class="row" style="padding-bottom:15px;">
                    	<div class="col-md-5"><span class="quick-quote-price-weight" style="width:105px;">Up to 15kg:</span> <span data-bind="text: Localise.formatCurrency(PriceIncTax())" class="quick-quote-price" id='data-15-express'><img src='<?php bloginfo('template_url');?>/images/spinner.gif' /></span></div>
                    		<div class="col-md-7"> <a id="express-15-button"  href="http://www.expressmystuff.co.uk/order?cf=GB&amp;ct=ES&amp;pr=92.46&amp;kg=15&amp;protocol=express" data-orig="http://www.expressmystuff.co.uk/order?cf=GB&amp;ct=ES&amp;pr=92.46&amp;kg=15&amp;protocol=express" class="bnbtn btn btn-primary" data-price="">Book Now (15kg)</a></div>
						</div><!-- END INNER ROW --!>
                  	                  	                   	                    	<div class="row" style="padding-bottom:15px;">
                    	<div class="col-md-5"><span class="quick-quote-price-weight" style="width:105px;">Up to 30kg:</span> <span data-bind="text: Localise.formatCurrency(PriceIncTax())" class="quick-quote-price" id='data-30-express'><img src='<?php bloginfo('template_url');?>/images/spinner.gif' /></span></div>
                    		<div class="col-md-7"> <a id="express-30-button" href="http://www.expressmystuff.co.uk/order?cf=GB&amp;ct=ES&amp;pr=136.02&amp;kg=30&amp;protocol=express" data-orig="http://www.expressmystuff.co.uk/order?cf=GB&amp;ct=ES&amp;pr=136.02&amp;kg=30&amp;protocol=express" class="bnbtn btn btn-primary" data-price="">Book Now (30kg)</a></div>
						</div><!-- END INNER ROW --!>
